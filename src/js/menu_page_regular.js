...
function renderBestRegular() {
  ...
  bestRegularData.forEach(bestRegulars => {
    ...
    for (let i = 0; i < bestRegulars.rating; i++) {
    ...
    imgMinus.src = bestRegulars.buttonImageMinus;
    imgMinus.alt = 'Minus';
    ...
    button.textContent = bestRegulars.button;
